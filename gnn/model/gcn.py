...
class GCN(nn.Module):
    def __init__(self,
        ...
        ## input layer
        self.GClayers.append(GraphConv(257, num_hidden, activation=F.elu))
    ...
    def inference(self, node_count_by_type, features_list):
        ...
        e_feature = torch.cat((e_feature, torch.zeros((e_feature.shape[0], self.m_fea_dim))), 1)  # [384, e_dim+129] i.e. [384, 257]
        # print(f'e_feature: {e_feature.shape}')
